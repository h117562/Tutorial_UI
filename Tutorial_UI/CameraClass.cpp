...
CameraClass::CameraClass()
{
	...
	DirectX::XMFLOAT3 m_lookAt = DirectX::XMFLOAT3(0.0f, 0.0f, 1.0f);
	
	m_upVector = DirectX::XMLoadFloat3(&up);
	m_lookAtVector = DirectX::XMLoadFloat3(&m_lookAt);
...
void CameraClass::UpdateRotation(DirectX::XMFLOAT2 rotation)
{
